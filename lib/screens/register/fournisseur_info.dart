...
class FournisseurInfo extends StatefulWidget {
  ...
  @override
  State<FournisseurInfo> createState() => _FournisseurInfo();
}

class _FournisseurInfo extends State<FournisseurInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      value: selectedValues.isNotEmpty ? selectedValues : null,
      items: genderItems
          .map((item) => DropdownMenuItem<List<String>>(
                        value: selectedValues.toList(),
                        child: CheckboxListTile(
                          title: Text(
                            item,
                            style: const TextStyle(fontSize: 14),
